...
public class IntArrayField extends BaseField<int[]>{

	private static final ComparableIntArrayCodec COMPARABLE_INT_ARRAY_CODEC = ComparableIntArrayCodec.INSTANCE;

	private final IntArrayFieldKey key;

	public IntArrayField(IntArrayFieldKey key, int[] value){
		super(null, value);
		this.key = key;
	}

	@Override
	public IntArrayFieldKey getKey(){
		return key;
	}
