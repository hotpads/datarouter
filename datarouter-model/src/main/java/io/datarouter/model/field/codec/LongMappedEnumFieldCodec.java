...
public class LongMappedEnumFieldCodec<E> extends FieldCodec<E,Long>{

	public LongMappedEnumFieldCodec(MappedEnum<E,Long> mappedEnum){
	...
	private static <E> String makeDocString(MappedEnum<E,Long> mappedEnum){
