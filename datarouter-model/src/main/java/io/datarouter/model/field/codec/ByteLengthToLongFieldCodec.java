...
public class ByteLengthToLongFieldCodec extends FieldCodec<ByteLength,Long>{
	...
	public ByteLengthToLongFieldCodec(){
		super(TypeToken.get(ByteLength.class),
				NullPassthroughCodec.of(ByteLength::toBytes, ByteLength::ofBytes),
				Comparator.comparingLong(ByteLength::toBytes),
				ByteLength.ofBytes(0),
				null);
	}
