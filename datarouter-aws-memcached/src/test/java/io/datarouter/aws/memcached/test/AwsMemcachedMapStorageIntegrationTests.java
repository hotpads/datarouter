...
public class AwsMemcachedMapStorageIntegrationTests extends BaseMapStorageIntegrationTests{

	@BeforeClass
	protected void beforeClass(){
		setup(DatarouterAwsMemcachedTestClientIds.AWS_MEMCACHED, Optional.empty());
	}
