 ...
 */
package io.datarouter.gcp.bigtable.paths;
...
@Singleton
public class DatarouterBigTablePaths extends PathNode implements PathsRoot{
	...
	public static class ClientPaths extends PathNode{
		public final PathNode bigtable = leaf("bigtable");
	}
