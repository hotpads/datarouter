...
public class ZoneIdLegacySerializerTests{
	...
	private static final List<TestInput> INPUTS = List.of(
			new TestInput(ZoneId.of("Europe/Paris"), "{\"id\":\"Europe/Paris\"}"),
			new TestInput(ZoneOffset.ofTotalSeconds(3), "{\"totalSeconds\":3}"));
