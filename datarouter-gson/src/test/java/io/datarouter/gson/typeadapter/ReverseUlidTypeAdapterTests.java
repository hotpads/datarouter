...
public class ReverseUlidTypeAdapterTests{

	private static final Gson GSON = GsonTool.withoutEnums();
	private static final ReverseUlid ULID = new ReverseUlid("01GFBY0JM7CN0E1J6WNAQHR17P");
	...
	public void testRoundTrip(){
		...
		ReverseUlid output = GSON.fromJson(json, ReverseUlid.class);
