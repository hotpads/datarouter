...
public class UlidReversedTypeAdapterTests{

	private static final Gson GSON = DatarouterGsons.withoutEnums();
	private static final UlidReversed ULID = new UlidReversed("01GFBY0JM7CN0E1J6WNAQHR17P");
	...
	public void testRoundTrip(){
		...
		UlidReversed output = GSON.fromJson(json, UlidReversed.class);
