...
public class DatarouterRedisClusterTestNgModuleFactory extends TestNgModuleFactory{

	public DatarouterRedisClusterTestNgModuleFactory(){
		super(Arrays.asList(
				new DatarouterWebGuiceModule(),
				new RedisClusterGuiceModule()));
	}

	public static class RedisClusterGuiceModule extends BaseGuiceModule{

		@Override
		protected void configure(){
			bind(DatarouterService.class).to(NoOpDatarouterService.class);
			bind(DatarouterProperties.class).to(RedisClusterDatarouterProperties.class);
			bindDefault(ServerTypeDetector.class, NoOpServerTypeDetector.class);
		}

	}

	public static class RedisClusterDatarouterProperties extends TestDatarouterProperties{

		@Override
		public String getDatarouterPropertiesFileLocation(){
			return getTestConfigDirectory() + "/redis-cluster.properties";
		}
