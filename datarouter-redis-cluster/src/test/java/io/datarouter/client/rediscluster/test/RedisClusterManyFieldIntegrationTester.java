...
public class RedisClusterManyFieldIntegrationTester extends BaseManyFieldIntegrationTests{

	@BeforeClass
	public void beforeClass(){
		setup(RedisClusterTestClientIds.REDIS_CLUSTER, ManyFieldTypeBeanFielder::new);
	}
