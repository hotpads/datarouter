...
public class DatarouterAutoGeneratedIdTestRouter extends BaseRouter implements TestRouter{
	...
	@Inject
	public DatarouterAutoGeneratedIdTestRouter(Datarouter datarouter, NodeFactory nodeFactory){
		super(datarouter);

		putOpIdGeneratedManaged = nodeFactory.create(DatarouterMysqlTestClientids.MYSQL,
				PutOpIdGeneratedManagedTestBean::new, PutOpIdGeneratedManagedTestBeanFielder::new).buildAndRegister();
		putOpIdGeneratedRandom = nodeFactory.create(DatarouterMysqlTestClientids.MYSQL,
				PutOpIdGeneratedRandomTestBean::new, PutOpIdGeneratedRandomTestBeanFielder::new).buildAndRegister();
	}
