...
@Singleton
public class DatarouterTestCaseInsensitiveRouter extends BaseRouter implements TestRouter{

	public final SortedMapStorage<CaseInsensitiveTestPrimaryKey,CaseInsensitiveTestDatabean>
			caseInsensitiveTestDatabean;

	@Inject
	public DatarouterTestCaseInsensitiveRouter(Datarouter datarouter, NodeFactory nodeFactory){
		super(datarouter);
		caseInsensitiveTestDatabean = nodeFactory.create(DatarouterMysqlTestClientids.MYSQL,
				CaseInsensitiveTestDatabean::new, CaseInsensitiveTestFielder::new).buildAndRegister();
	}
