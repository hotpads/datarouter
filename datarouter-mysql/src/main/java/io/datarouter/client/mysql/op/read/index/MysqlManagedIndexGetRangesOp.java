...
extends BaseMysqlOp<List<IE>>{
	...
	public MysqlManagedIndexGetRangesOp(Datarouter datarouter, PhysicalNode<PK,D,F> node,
	...
	public List<IE> runOnce(){
		...
		List<IE> result = MysqlTool.selectDatabeans(fieldCodecFactory, fieldInfo, statement);
