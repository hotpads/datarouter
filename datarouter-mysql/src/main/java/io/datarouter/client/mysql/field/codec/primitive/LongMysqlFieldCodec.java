...
extends BasePrimitiveMysqlFieldCodec<Long,Field<Long>>{
	...
	public LongMysqlFieldCodec(){//no-arg for reflection
		this(null);
	}

	public LongMysqlFieldCodec(Field<Long> field){
		super(field);
	}
	...
	public SqlColumn getSqlColumnDefinition(boolean allowNullable){
		return new SqlColumn(field.getKey().getColumnName(), getMysqlColumnType(), 20, allowNullable && field.getKey()
				.isNullable(), false);
	}
