...
public class DelimitedStringListMysqlFieldCodec
extends BaseListMysqlFieldCodec<String,List<String>,DelimitedStringListField>{

	public DelimitedStringListMysqlFieldCodec(DelimitedStringListField field){
		super(field);
	}
	...
	public List<String> fromMysqlResultSetButDoNotSet(ResultSet rs){
		try{
			...
			return DelimitedStringListField.decode(dbValue, field.getSeparator());
	...
	public void setPreparedStatementValue(PreparedStatement ps, int parameterIndex){
		try{
			ps.setString(parameterIndex, DelimitedStringListField.encode(field.getValue(), field.getSeparator()));
		}catch(SQLException e){
			throw new DataAccessException(e);
		}
	}
