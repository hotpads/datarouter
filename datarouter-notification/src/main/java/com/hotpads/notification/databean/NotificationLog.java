...
public class NotificationLog extends BaseDatabean<NotificationLogKey,NotificationLog>{
	...
	private static class FieldKeys{
		...
		private static final DelimitedStringArrayFieldKey itemIds = new DelimitedStringArrayFieldKey("itemIds", ",");
		private static final StringFieldKey channel = new StringFieldKey("channel");
		private static final StringFieldKey id = new StringFieldKey("id").withSize(LENGTH_id);
	}
	...
	public static class NotificationLogFielder extends BaseDatabeanFielder<NotificationLogKey, NotificationLog>{
		...
		public Map<String,List<Field<?>>> getIndexes(NotificationLog notificationLog){
			...
			map.put("index_notificationId", new NotificationIdLookup(notificationLog.id).getFields());
