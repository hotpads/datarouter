...
public class NotificationTimingStrategyMapping extends BaseDatabean<NotificationTimingStrategyMappingKey, NotificationTimingStrategyMapping> {
  ...
  public static class NotificationTimingStrategyMappingFielder extends BaseDatabeanFielder<NotificationTimingStrategyMappingKey, NotificationTimingStrategyMapping> {
    ...
    public List<Field<?>> getNonKeyFields(NotificationTimingStrategyMapping databean) {
      return Arrays.asList(
          new StringField(FieldKeys.timingStrategy, databean.timingStrategy));
    }
  }
}
