...
public class SystemTablesCopyLink extends DatarouterLink{
	...
	public SystemTablesCopyLink(){
		super(new DatarouterCopyTablePaths().datarouter.systemTableCopier.viewTables);
	}
