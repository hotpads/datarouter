...
public interface SortedMapStorage<PK extends PrimaryKey<PK>,D extends Databean<PK>>
extends MapStorage<PK,D>, SortedStorage<PK,D>, 
		SortedMapStorageReader<PK,D>, SortedMapStorageWriter<PK,D>
{
	public interface SortedMapStorageNode<PK extends PrimaryKey<PK>,D extends Databean<PK>>
	...
	public interface PhysicalSortedMapStorageNode<PK extends PrimaryKey<PK>,D extends Databean<PK>>
