...
public interface IndexedMapStorageWriter<PK extends PrimaryKey<PK>,D extends Databean<PK>>
extends MapStorageWriter<PK,D>, IndexedStorageWriter<PK,D>
{
	public interface IndexedMapStorageWriterNode<PK extends PrimaryKey<PK>,D extends Databean<PK>>
	extends MapStorageWriterNode<PK,D>, IndexedStorageWriterNode<PK,D>
	{
	}

	public interface PhysicalIndexedMapStorageWriterNode<PK extends PrimaryKey<PK>,D extends Databean<PK>>
