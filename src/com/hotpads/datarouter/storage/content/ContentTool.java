...
public class ContentTool {
	...
	public static <D extends Databean,C extends ContentHolder<D>> 
	Map<Key<D>,C> getByKey(Collection<C> in){
	...
	public static <D extends Databean,H extends ContentHolder<D>> 
	boolean equalsContent(H a, H b){
	...
	public static <D extends Databean,H extends ContentHolder<D>> 
	boolean equalsContent(Collection<? extends H> as, Collection<? extends H> bs){
		if(CollectionTool.differentSize(as, bs)){ return false; }
		if(ObjectTool.bothNull(as, bs)){ return true; }
		Map<Key<D>,? extends H> asContentByKey = ContentTool.getByKey(as);
