...
//		System.out.println(" index " + index);
	...
	public static class ConnectionSqlTableGeneratorTester{//localhost only
		...
		public void getTableAutoIncrementTest() throws SQLException{
			String databaseName = "drTest0";
			Connection conn = JdbcTool.openConnection("localhost", 3306, databaseName, "root", "");


			List<String> tableNames = JdbcTool.showTables(conn);
			String autoGeneratedKeyBeanSqlTableName = tableNames.get(tableNames.indexOf(AutoGeneratedKeyBean.class.getSimpleName()));
			ConnectionSqlTableGenerator creator = new ConnectionSqlTableGenerator(conn, autoGeneratedKeyBeanSqlTableName, databaseName);
