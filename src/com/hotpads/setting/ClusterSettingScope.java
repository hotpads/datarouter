...
//	}
	...
	public static ClusterSettingScope fromParams(ServerType serverType, String instance, String application){
		...
		if(StringTool.notEmpty(application)){
			...
			s = "instance";
		}else if((serverType.getInteger() != ServerType.UNKNOWN.getInteger()) && (serverType.getInteger() != ServerType.ALL.getInteger())){
			s = "serverType";
		}else if(serverType.getInteger() == ServerType.ALL.getInteger()){
			s = "cluster";
		}else{
			s = "defaultScope";
		}
