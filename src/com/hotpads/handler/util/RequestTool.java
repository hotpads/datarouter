...
public class RequestTool {
	...
	public static String getSubmitAction(
			HttpServletRequest request, String defaultAction){
	...
	public static String getUriFromSlashedParts(
			HttpServletRequest request, List<String> slashedParts){
	...
	public static String get(HttpServletRequest request, String paramName){
		...
		if(stringVal==null){
			throw new IllegalArgumentException(
					"expected String:"+paramName+", but was null");
		}
		return stringVal;
	}
...
//			ServletRequestUtils.getStringParameter(request, paramName, null);
	...
	public static Integer getIntegerParameterNullSafe(
			HttpServletRequest request, String paramName, Integer defaultValue){
		String stringVal = get(request, paramName, null);
		return NumberTool.getIntegerNullSafe(stringVal,defaultValue);
	}
	...
	public static Boolean getBooleanParameterNullSafeStandardJava(
			HttpServletRequest request, 
			String paramName, 
	...
	public static Boolean getBooleanParameterNullSafeCustomValues(
			HttpServletRequest request, String paramName, Boolean defaultValue){
		String stringVal = get(request, paramName, null);
	...
	public static void setAttributes(
			HttpServletRequest request, Map<String,Object> attributeMap){
	 ...
	 * @return
	 */
	public static DefaultableMap<String, String> getParamMap(
			HttpServletRequest request) {
		DefaultableHashMap<String, String> map = 
			new DefaultableHashMap<String,String>();
		return getParameterMap(map,request);
	}
	public static NavigableMap<String, String> getMapOfParameters(
			HttpServletRequest request){
		NavigableMap<String, String> map = new TreeMap<String, String>();
		return getParameterMap(map,request);
	}
	
	public static <M extends Map<String,String>> M 
	getParameterMap(M map, HttpServletRequest request){
	...
	public static NavigableMap<String, String> getMapOfParametersMatchingPrefix(
	...
	public static boolean checkDouble(
			Double d, boolean allowNull,  boolean allowNegative){
	...
	public static List<String> getCheckedBoxes(
			HttpServletRequest request, String prefix){
		return getCheckedBoxes(request,prefix,new IdentityFunctor<String>());
	}
	
	@SuppressWarnings("unchecked")
	public static <T> List<T> getCheckedBoxes(
			HttpServletRequest request, String prefix, Functor<T,String> converter){
	 ...
	 * @return redirect uri
	 */
	public static String makeRedirectUriIfTrailingSlash(
			HttpServletRequest request){
		return makeRedirectUriIfTrailingSlash(
				request.getRequestURI(), request.getQueryString());
	}
	private static String makeRedirectUriIfTrailingSlash(
	...
	private static String getRequestURIWithQueryString(
			String uri, String queryString){
		return uri + (queryString==null?"":"?"+queryString);
	}
	...
	public static URL getFullyQualifiedUrl(
			String path, HttpServletRequest similarRequest){
		if(!path.startsWith("/")){
			path = "/"+path;
		}
		String requestUrl = similarRequest.getRequestURL().toString();
		return getFullyQualifiedUrl(path, requestUrl, 
				similarRequest.getServerName(), 
				similarRequest.getServerPort());
	}
	
	public static URL getFullyQualifiedUrl(
			String path, String similarUrl, String serverName, int port){
		if(!path.startsWith("/")){
			path = "/"+path;
		}
	...
	public static class Tests {
		@Test public void testCheckDouble(){
			...
			Assert.assertFalse(checkDouble(Double.NEGATIVE_INFINITY,
											false,false,false,false));
			Assert.assertFalse(checkDouble(Double.NEGATIVE_INFINITY,
											false,true,false,false));
			Assert.assertFalse(checkDouble(Double.NEGATIVE_INFINITY,
											false,false,true,false));
			Assert.assertTrue(checkDouble(Double.NEGATIVE_INFINITY,
											false,true,true,false));
			Assert.assertFalse(checkDouble(Double.POSITIVE_INFINITY,
											false,false,false,false));
			Assert.assertTrue(checkDouble(Double.POSITIVE_INFINITY,
											false,false,true,false));
		...
		@Test public void testMakeRedirectUriIfTrailingSlash(){ 
			Assert.assertEquals(null,
					makeRedirectUriIfTrailingSlash("example.com",null));
			Assert.assertEquals("example.com",
					makeRedirectUriIfTrailingSlash("example.com/",null));
			Assert.assertEquals("example.com?stuff=things",
					makeRedirectUriIfTrailingSlash(
		...
		@Test public void testGetFullyQualifiedUrl(){
			Assert.assertEquals(
					...
					getFullyQualifiedUrl(
							"aurl","http://x.com","x.com",80).toString());
			Assert.assertEquals(
					"http://x.com/aurl",
					getFullyQualifiedUrl(
							"/aurl","http://x.com","x.com",80).toString());
			Assert.assertEquals(
					"https://x.com:80/aurl",
					getFullyQualifiedUrl(
							"/aurl","https://x.com","x.com",80).toString());
			Assert.assertEquals(
					"https://x.com/aurl",
					getFullyQualifiedUrl(
							"/aurl","https://x.com","x.com",443).toString());
			Assert.assertEquals(
					"https://x.com/",
					getFullyQualifiedUrl(
							"/","https://x.com","x.com",443).toString());
			Assert.assertEquals(
					"https://x.com/",
					getFullyQualifiedUrl(
							"","https://x.com","x.com",443).toString());
			Assert.assertEquals(
					"http://x.com:8080/",
					getFullyQualifiedUrl(
							"","http://x.com:8080","x.com",8080).toString());
			Assert.assertEquals(
					"https://x.com:8443/snack",
					getFullyQualifiedUrl(
							"snack","https://x.com","x.com",8443).toString());
		}
	}	
}