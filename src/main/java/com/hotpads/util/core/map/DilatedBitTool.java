...
public class DilatedBitTool{
	...
	public static class DilatedBitToolTests {
		@Test public void test(){
			...
			Assert.assertEquals(lsdtnum, LEFT_SHIFTED_DILATED_TABLE[3]);
			Assert.assertEquals(dtnum, DILATED_TABLE[3]);			
		}
		
		@Test public void test2(){
			int lsdtnum = 136, dtnum = 68;
			Assert.assertEquals(lsdtnum, LEFT_SHIFTED_DILATED_TABLE[10]);
			Assert.assertEquals(dtnum, DILATED_TABLE[10]);
	...
	public static void main (String[] args) {
		...
		System.out.println("M_D_B: " + DilatedBitTool.MAX_DILATED_BITS + " H_G_B: " + DilatedBitTool.HALF_GRID_BITS);
		System.out.println("Table_slots: " + DilatedBitTool.TABLE_SLOTS);
		System.out.println("Half_grid_bits: " + Long.toBinaryString(HALF_GRID_BITS));
