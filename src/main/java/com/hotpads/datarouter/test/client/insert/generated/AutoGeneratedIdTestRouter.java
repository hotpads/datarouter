...
public class AutoGeneratedIdTestRouter extends BaseDataRouter{
	...
	@Inject
	public AutoGeneratedIdTestRouter(DataRouterContext context){
		super(context, NAME);
		
		putOpIdGeneratedManaged = cast(register(NodeFactory.create(DRTestConstants.CLIENT_drTestJdbc0,
				PutOpIdGeneratedManagedTestBean.class, PutOpIdGeneratedManagedTestBeanFielder.class, this)));
		putOpIdGeneratedRandom = cast(register(NodeFactory.create(DRTestConstants.CLIENT_drTestJdbc0,
				PutOpIdGeneratedRandomTestBean.class, PutOpIdGeneratedRandomTestBeanFielder.class, this)));
