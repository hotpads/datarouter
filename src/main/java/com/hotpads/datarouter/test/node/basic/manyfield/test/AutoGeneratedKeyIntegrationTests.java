...
public class AutoGeneratedKeyIntegrationTests {
	...
	public AutoGeneratedKeyIntegrationTests(ClientType clientType){
		...
		this.router = new ScatteringPrefixBasicNodeTestRouter(injector.getInstance(DatarouterContext.class), injector
				.getInstance(NodeFactory.class), DRTestConstants.CLIENT_drTestHibernate0,
