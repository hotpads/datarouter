...
import com.hotpads.datarouter.test.node.basic.autogenkey.AutoGeneratedKeyIntegrationTestsDisabled;
...
public class BasicNodeTestRouter extends BaseDatarouter{
	...
	public BasicNodeTestRouter(DatarouterContext drContext, NodeFactory nodeFactory, String clientName, 
		...
		if(AutoGeneratedKeyIntegrationTestsDisabled.class.equals(testType)){
