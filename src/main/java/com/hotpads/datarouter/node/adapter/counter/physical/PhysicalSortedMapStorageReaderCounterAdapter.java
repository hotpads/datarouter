...
import com.hotpads.datarouter.node.adapter.counter.SortedMapStorageReaderCounterAdapter;
...
public class PhysicalSortedMapStorageReaderCounterAdapter<
		PK extends PrimaryKey<PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>,
		PN extends PhysicalSortedMapStorageReaderNode<PK,D>>
extends SortedMapStorageReaderCounterAdapter<PK,D,F,PN>
implements PhysicalSortedMapStorageReaderNode<PK,D>{

	
	public PhysicalSortedMapStorageReaderCounterAdapter(PN backingNode){		
		super(backingNode);
	}
