...
implements SortedStorageReaderNode<PK,D>{
	...
	public D getFirst(Config pConfig){
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getFirst));
		return backingNode.getFirst(config);
	}

	@Override
	public PK getFirstKey(Config pConfig){
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getFirstKey));
	...
	public List<D> getPrefixedRange(
		...
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getPrefixedRange));
	...
	public List<PK> getKeysInRange(PK start, boolean startInclusive, PK end,
		...
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getKeysInRange));
	...
	public List<D> getRange(PK start, boolean startInclusive, PK end,
			boolean endInclusive, Config pConfig){
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getRange));
	...
	public List<D> getWithPrefix(PK prefix, boolean wildcardLastField, Config pConfig){
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getWithPrefix));
	...
	public List<D> getWithPrefixes(Collection<PK> prefixes, boolean wildcardLastField, Config pConfig){
		Config config = Config.nullSafe(pConfig).setCallsite(getCallsite(SortedStorageReader.OP_getWithPrefixes));
