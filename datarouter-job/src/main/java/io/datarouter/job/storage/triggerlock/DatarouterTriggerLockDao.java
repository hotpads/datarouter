...
public class DatarouterTriggerLockDao extends BaseDao{
	...
	public record DatarouterTriggerLockDaoParams(List<ClientId> clientIds){
	}

	private final SortedMapStorageNode<TriggerLockKey,TriggerLock,TriggerLockFielder> node;
	...
	public DatarouterTriggerLockDao(
		...
		node = Scanner.of(params.clientIds)
				.map(clientId -> {
					SortedMapStorageNode<TriggerLockKey,TriggerLock,TriggerLockFielder> node =
