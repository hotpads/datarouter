...
public class TracesSplittingStringBuildersIntegrationTests{

	public static final Trace2BundleDto EMPTY = new Trace2BundleDto(null, null, null);
	public static final String EMPTY_ENCODED = toBase64ByteString(GsonTool.GSON.toJson(EMPTY));
	public static final int EMPTY_LENGTH = EMPTY_ENCODED.length();

	@Test
	public void testTooSmallForAnything(){
		//not long enough for any item, so everything should be discarded
		var builder = new TraceBlobDto.TracesSplittingStringBuilders(EMPTY_LENGTH - 1);
	...
	public void testFileSplitting(){
		...
		var builder = new TraceBlobDto.TracesSplittingStringBuilders(EMPTY_LENGTH * 2);
		builder.append(EMPTY);
		builder.append(EMPTY);
		...
		builder = new TraceBlobDto.TracesSplittingStringBuilders(EMPTY_LENGTH * 2 + 1);
		builder.append(EMPTY);
		builder.append(EMPTY);
	...
	public void testNormalSizeAppending(){
		var builder = new TraceBlobDto.TracesSplittingStringBuilders(256 * 1024 - 30);
