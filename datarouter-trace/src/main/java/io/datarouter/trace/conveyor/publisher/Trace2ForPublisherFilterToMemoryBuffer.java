...
public class Trace2ForPublisherFilterToMemoryBuffer extends BaseTrace2FilterToMemoryBuffer{
	...
	@Inject
	public Trace2ForPublisherFilterToMemoryBuffer(DatarouterTracePublisherSettingRoot settings){
		super("trace2PublisherBuffer", settings.runMemoryToSqsForTrace2);
	}
}
