...
public class TraceCategoryFieldCodec
extends BinaryDtoConvertingFieldCodec<TraceCategory,String>{

	public TraceCategoryFieldCodec(){
		super(
				type -> type.persistentString,
				TraceCategory.BY_PERSISTENT_STRING::fromOrThrow,
