...
public class TraceSpanBinaryDto extends BinaryDto<TraceSpanBinaryDto>{
	...
	public TraceSpanBinaryDto(Trace2SpanDto dto){
		this(
				dto.traceparent,
				dto.parentThreadId,
				dto.sequence,
	...
	public static TraceSpanBinaryDto decode(byte[] bytes){
		return BinaryDtoIndexedCodec.of(TraceSpanBinaryDto.class).decode(bytes);
	}
