...
public class TraceThreadQueueBinaryDto extends BinaryDto<TraceThreadQueueBinaryDto>{
	...
	public TraceThreadQueueBinaryDto(
	...
	public TraceThreadQueueBinaryDto(TraceThreadDto dto){
		this(
				dto.traceparent,
				dto.threadId,
				dto.parentThreadId,
	...
	public static TraceThreadQueueBinaryDto decode(byte[] bytes){
		return BinaryDtoIndexedCodec.of(TraceThreadQueueBinaryDto.class).decode(bytes);
	}
