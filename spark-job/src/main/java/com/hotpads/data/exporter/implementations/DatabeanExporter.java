...
implements DataExporter{
	private static final Logger logger = LoggerFactory.getLogger(DatabeanExporter.class);
	...
	private final List<ExportProgressListener<String>> listeners = new CopyOnWriteArrayList<>();
	...
	public DatabeanExporter(String jobId, String tableName, String columnsToSelect, DatabeanFielder<PK, D> fielder,
	...
	@Override
	public void addProgressListener(ExportProgressListener<String> listener){
		listeners.add(listener);
	}

	private void updateListeners(String data){
		for(ExportProgressListener<String> listener : listeners){
