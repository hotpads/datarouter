...
public class KinesisClientType extends BaseClientType{
	...
	public ClientFactory createClientFactory(Datarouter datarouter, String clientName){
		KinesisOptions kinesisOptions = new KinesisOptions(datarouter, clientName, streamName, regionName, arnRole);
		return new KclConsumerClientFactory(clientName, this, kinesisOptions, clientAvailabilitySettings);
	}
