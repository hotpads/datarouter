...
public class OpOptimizedBatchSizeKey extends BaseRegularPrimaryKey<OpOptimizedBatchSizeKey>{
	...
	public List<Field<?>> getFields(){
		return Arrays.asList(new StringField(FieldKeys.opName, opName));
	}
