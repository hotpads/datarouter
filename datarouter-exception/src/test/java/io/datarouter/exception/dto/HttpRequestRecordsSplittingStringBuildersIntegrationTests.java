...
public class HttpRequestRecordsSplittingStringBuildersIntegrationTests{
	...
	public void testTooSmallForAnything(){
		...
		var builder = new HttpRequestRecordBlobDto.HttpRequestRecordsSplittingStringBuilders(EMPTY_LENGTH - 1);
	...
	public void testFileSplitting(){
		...
		var builder = new HttpRequestRecordBlobDto.HttpRequestRecordsSplittingStringBuilders(EMPTY_LENGTH * 2);
		builder.append(EMPTY);
		builder.append(EMPTY);
		...
		builder = new HttpRequestRecordBlobDto.HttpRequestRecordsSplittingStringBuilders(EMPTY_LENGTH * 2 + 1);
		builder.append(EMPTY);
		builder.append(EMPTY);
	...
	public void testNormalSizeAppending(){
		var builder = new HttpRequestRecordBlobDto.HttpRequestRecordsSplittingStringBuilders(256 * 1024 - 30);
