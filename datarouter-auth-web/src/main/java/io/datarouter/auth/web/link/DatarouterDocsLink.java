...
public class DatarouterDocsLink extends DatarouterLink{
	...
	public Optional<String> endpoint = Optional.empty();

	public DatarouterDocsLink(){
		super(new DatarouterAuthPaths().docs);
	}

	public DatarouterDocsLink withEndpoint(String endpoint){
		this.endpoint = Optional.of(endpoint);
		return this;
	}

	public DatarouterDocsLink withOptEndpoint(Optional<String> endpoint){
