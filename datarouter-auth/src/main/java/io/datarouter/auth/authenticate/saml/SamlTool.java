...
public class SamlTool{
	...
	public static MessageContext buildAuthnRequestAndContext(AuthnRequestMessageConfig config){
		...
		authnRequestContext.getSubcontext(SAMLPeerEntityContext.class, true)
				.getSubcontext(SAMLEndpointContext.class, true)
				.setEndpoint(buildIdpEndpoint(config.identityProviderSingleSignOnServiceUrl()));
	...
	public static void redirectWithAuthnRequestContext(
