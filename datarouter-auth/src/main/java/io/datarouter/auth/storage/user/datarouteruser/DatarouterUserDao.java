...
import io.datarouter.auth.storage.user.datarouteruser.DatarouterUser.DatarouterUserFielder;
...
public class DatarouterUserDao extends BaseDao{
	...
	public record DatarouterUserDaoParams(List<ClientId> clientIds){
	}
