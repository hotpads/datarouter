...
import io.datarouter.auth.storage.user.deprovisioneduser.DeprovisionedUser.DeprovisionedUserFielder;
...
public class DeprovisionedUserDao extends BaseDao{
	...
	public record DeprovisionedUserDaoParams(List<ClientId> clientIds){
	}
