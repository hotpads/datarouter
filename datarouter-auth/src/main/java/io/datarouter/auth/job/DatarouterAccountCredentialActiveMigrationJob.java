...
public class DatarouterAccountCredentialActiveMigrationJob extends BaseJob{
	...
	@Inject
	public DatarouterAccountCredentialActiveMigrationJob(DatarouterAccountCredentialDao dao){
		this.dao = dao;
	}
	...
	public void run(TaskTracker tracker){
		dao.scan()
				.include(DatarouterAccountCredential::needsMigration)
				.each(dao -> dao.setActive(true))
				.flush(dao::updateMultiIgnore);
	}
