...
@Singleton
public class BigtableClientNodeFactory
implements DatabeanClientNodeFactory{

	@Inject
	private NodeAdapters nodeAdapters;
	@Inject
	private BigtableClientManager bigTableClientManager;
	@Inject
	private BigtableClientType clientType;
