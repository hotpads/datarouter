...
public interface WebSocketService{
	...
	default void onClose(@SuppressWarnings("unused") WebSocketSession webSocketSession){
	}

	default void onSessionVacuum(@SuppressWarnings("unused") WebSocketSessionKey webSocketSessionKey){
	}
