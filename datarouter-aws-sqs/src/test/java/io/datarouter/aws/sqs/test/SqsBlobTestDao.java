...
@Singleton
public class SqsBlobTestDao extends BaseDao implements TestDao{

	private final BlobQueueStorage node;

	@Inject
	public SqsBlobTestDao(Datarouter context, QueueNodeFactory queueNodeFactory){
		super(context);
		node = queueNodeFactory.createBlobQueue(DatarouterSqsTestClientIds.SQS, "SqsBlobTest")
				.buildAndRegister();
	}
