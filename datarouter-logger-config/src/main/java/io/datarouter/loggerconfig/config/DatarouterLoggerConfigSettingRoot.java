...
public class DatarouterLoggerConfigSettingRoot extends SettingRoot{
	...
	public final CachedSetting<Boolean> sendLoggerConfigCleanupJobEmails;
	...
	public DatarouterLoggerConfigSettingRoot(SettingFinder finder){
		...
		sendLoggerConfigCleanupJobEmails = registerBoolean("sendLoggerConfigCleanupJobEmails", false);
	}
