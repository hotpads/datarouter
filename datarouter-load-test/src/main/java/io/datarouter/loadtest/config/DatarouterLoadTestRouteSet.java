...
public class DatarouterLoadTestRouteSet extends BaseRouteSet{
	...
	public DatarouterLoadTestRouteSet(DatarouterLoadTestPaths paths){
		...
		handleDir(paths.datarouter.loadTest.get).withHandler(LoadTestGetHandler.class);
		handleDir(paths.datarouter.loadTest.insert).withHandler(LoadTestInsertHandler.class);
		handleDir(paths.datarouter.loadTest.scan).withHandler(LoadTestScanHandler.class);
	}
