...
/**
 * Allows validation and execution of a particular {@link SecretClientOpType}, given a {@link SecretClient} and input.
 * Returns a {@link SecretClientOpResult} containing the output or validation/execution failure information. See
 * {@link SecretClientOps} for standard implementations.
 *
 * @param <I> input type
 * @param <O> output type
 */
public abstract class SecretClientOp<I,O>{
	...
	private final SecretClientOpType opType;

	public SecretClientOp(String opCounterName, BiFunction<SecretClient,I,O> opMethod, SecretClientOpType opType){
	...
	public SecretClientOp(String validationCounterName, String opCounterName,
			BiConsumer<SecretClient,I> validationMethod, BiFunction<SecretClient,I,O> opMethod,
			SecretClientOpType opType){
	...
	public SecretClientOpType getOpType(){
		return opType;
	}
