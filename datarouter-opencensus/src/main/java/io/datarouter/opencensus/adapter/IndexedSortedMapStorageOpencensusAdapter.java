...
public class IndexedSortedMapStorageOpencensusAdapter<
...
implements IndexedSortedMapStorageNode<PK,D,F>,
		...
		IndexedStorageOpencensusAdapterMixin<PK,D,F,N>{

	public IndexedSortedMapStorageOpencensusAdapter(N backingNode){
		super(backingNode);
	}
