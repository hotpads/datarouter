...
public class DatarouterMemoryTestNgModuleFactory extends TestNgModuleFactory{

	public DatarouterMemoryTestNgModuleFactory(){
		super(List.of(
				new DatarouterWebGuiceModule(),
				new MemoryGuiceModule()));
	}

	public static class MemoryGuiceModule extends BaseGuiceModule{
