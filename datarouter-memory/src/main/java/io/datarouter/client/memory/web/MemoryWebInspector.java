 ...
 */
package io.datarouter.client.memory.web;
...
public class MemoryWebInspector implements DatarouterClientWebInspector{
	...
	public Mav inspectClient(Params params, HttpServletRequest request){
		var clientParams = paramsFactory.new DatarouterWebRequestParams<>(params, MemoryClientType.class);
		...
		return pageFactory.startBuilder(request)
				.withTitle("Datarouter Client - Memory")
