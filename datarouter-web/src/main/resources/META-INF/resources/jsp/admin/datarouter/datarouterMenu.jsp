...
<body>
	...
	<div class="container">
		...
		<table class="table table-striped table-bordered table-hover table-condensed">
			<tr><td>configDirectory</td><td>${configDirectory}</td></tr>
			<tr><td>configProfile</td><td>${configProfile}</td></tr>
		...
		<h3><a href="${contextPath}/datarouter/instances?submitAction=inspectClientUrl">db instance summary</a></h3>
						...
						<c:choose>
							<c:when test="${lazyClientProvider.initialized}">
								...
								<td>
									...
									<a href="${contextPath}/datarouter/clients?submitAction=inspectClient&clientType=${client.type.name}&routerName=${router.name}&clientName=${client.name}">
										${client.name}
									</a>
								</td>
								<td>
