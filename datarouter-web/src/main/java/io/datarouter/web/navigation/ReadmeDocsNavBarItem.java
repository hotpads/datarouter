...
public class ReadmeDocsNavBarItem implements DynamicNavBarItem{
	...
	public NavBarItem getNavBarItem(){
		return new NavBarItem(AppNavBarCategory.DOCS, paths.documentation.readmes, "Readme Docs");
	}

	@Override
	public Boolean shouldDisplay(){
		return docNameAndLinksSupplier.getReadmeDocs().entrySet().size() != 0;
	}
