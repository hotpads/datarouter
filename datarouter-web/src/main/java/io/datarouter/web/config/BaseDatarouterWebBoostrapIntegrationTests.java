 ...
 */
public abstract class BaseDatarouterWebBoostrapIntegrationTests{
	...
	public void testSingletons(){
		getClassesToTestSingleton().forEach(pair -> checkSingletonForSubClasses(pair.getLeft(), pair.getRight()));
	}

	@Test
	public void testSingletonsForAppListeners(){
	...
	private void checkSingletonForSubClasses(Class<?> baseClass, boolean shouldBeSingleton){
