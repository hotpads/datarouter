...
public class DatarouterWebRequireJs{
	...
	public static final String BOOTSTRAP = register(
			"bootstrap",
			FILES.bootstrap.v3.js.bootstrapJs);
	...
	public static final String AUTOCOMPLETE = register(
			"autocomplete",
			FILES.autocomplete.autocompleteJs);
	...
	static{
		SHIMS.put(JQUERY_UI, List.of(JQUERY));
