...
public class ViewSystemDocsHandler extends BaseHandler{
	...
	public Mav view(){
		var rows = docNameAndLinksSupplier.getSystemDocs();
		return pageFactory.startBuilder(request)
				.withTitle("System or External Docs")
				.withRequires(DatarouterWebRequireJsV2.SORTTABLE)
				.withContent(ViewReadmesHandler.makeContent("System or External Docs", rows))
				.buildMav();
	}
