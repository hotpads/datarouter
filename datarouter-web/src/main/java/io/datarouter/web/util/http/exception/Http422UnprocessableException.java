...
public class Http422UnprocessableException extends HttpException{
	...
	public Http422UnprocessableException(String message){
		super(message, CODE);
	}

	public Http422UnprocessableException(String message, Throwable cause){
		super(message, cause, CODE);
	}

	public Http422UnprocessableException(Throwable cause){
		super(MESSAGE, cause, CODE);
	}
