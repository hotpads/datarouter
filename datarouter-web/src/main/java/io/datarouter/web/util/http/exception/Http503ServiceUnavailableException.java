...
public class Http503ServiceUnavailableException extends HttpException{
	...
	public Http503ServiceUnavailableException(String message){
		super(message, CODE);
	}

	public Http503ServiceUnavailableException(String message, Throwable cause){
		super(message, cause, CODE);
	}

	public Http503ServiceUnavailableException(Throwable cause){
		super(MESSAGE, cause, CODE);
	}
