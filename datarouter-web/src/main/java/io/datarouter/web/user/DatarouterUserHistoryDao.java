...
import io.datarouter.web.user.databean.DatarouterUserHistory.DatarouterUserHistoryFielder;
import io.datarouter.web.user.databean.DatarouterUserHistoryKey;

@Singleton
public class DatarouterUserHistoryDao extends BaseDao implements BaseDatarouterUserHistoryDao{
