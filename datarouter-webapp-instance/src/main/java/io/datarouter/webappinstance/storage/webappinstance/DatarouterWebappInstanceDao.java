...
public class DatarouterWebappInstanceDao extends BaseDao{
	...
	public Map<String,String> getServerTypeByServerName(){
		return node.scan()
				.collect(CollectorTool.toMap(app -> app.getKey().getServerName(), BaseWebappInstance::getServerType));
	}
	...
	public DatabeanVacuum<WebappInstanceKey,WebappInstance> makeVacuum(){
		...
		Predicate<WebappInstance> shouldDelete = databean -> databean.getRefreshedLast() == null
