...
@Singleton
public class BlockfileClientNodeFactory
		implements DatabeanClientNodeFactory{

	@Inject
	private BlockfileClientType blockfileClientType;
	@Inject
	...
	PhysicalNode<PK,D,F> createDatabeanNode(
		...
		//TODO add adapters, but they don't accept a read-only node
		return new BlockfileReaderNode<>(nodeParams, blockfileClientType);
	}
