...
public class BlockfileWebInspector implements DatarouterClientWebInspector{
	...
	public Mav inspectClient(Params params, HttpServletRequest request){
		var clientParams = paramsFactory.new DatarouterWebRequestParams<>(params, BlockfileClientType.class);
		...
		return pageFactory.startBuilder(request)
				.withTitle("Datarouter Client - Blockfile")
