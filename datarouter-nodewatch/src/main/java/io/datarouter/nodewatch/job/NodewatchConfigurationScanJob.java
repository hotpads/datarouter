...
public class NodewatchConfigurationScanJob extends BaseJob{
	...
	public void run(TaskTracker tracker){
		List<ConfigScanDto> scans = List.of(
				configScanner.checkRequiredNodewatchSettings(),
				configScanner.checkLatestTableMinimumCount());
		reportService.scanConfigurationAndSendEmail("NodewatchConfig Alert", scans);
	}
