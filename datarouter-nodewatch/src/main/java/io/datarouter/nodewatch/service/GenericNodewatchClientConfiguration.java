...
public class GenericNodewatchClientConfiguration implements NodewatchClientConfiguration{
	...
	public GenericNodewatchClientConfiguration(List<ClientId> countableClientIds){
		this.countableClientIds = countableClientIds;
	}

	@Override
	public boolean isCountableClient(ClientId clientId){
		return countableClientIds.contains(clientId);
	}
