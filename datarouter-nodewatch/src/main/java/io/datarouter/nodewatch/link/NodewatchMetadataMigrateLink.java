...
public class NodewatchMetadataMigrateLink extends DatarouterLink{
	...
	public NodewatchMetadataMigrateLink withSourceNodeName(String sourceNodeName){
		this.sourceNodeName = Optional.of(sourceNodeName);
		return this;
	}

	public NodewatchMetadataMigrateLink withTargetNodeName(String targetNodeName){
		this.targetNodeName = Optional.of(targetNodeName);
		return this;
	}
}
