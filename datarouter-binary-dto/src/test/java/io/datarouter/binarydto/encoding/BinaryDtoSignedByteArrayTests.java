...
public class BinaryDtoSignedByteArrayTests{
	...
	private static class EncodeTestDto extends ComparableBinaryDto<EncodeTestDto>{
	...
	private static class CompareTestDto extends ComparableBinaryDto<EncodeTestDto>{
		@BinaryDtoField(codec = SignedByteArrayBinaryDtoFieldCodec.class)
		public final byte[] f1;
