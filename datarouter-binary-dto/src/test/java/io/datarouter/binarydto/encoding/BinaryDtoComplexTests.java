...
public class BinaryDtoComplexTests{
	...
	private static class BooleanDto extends BinaryDto<BooleanDto>{
	...
	private static class ShortDto extends BinaryDto<ShortDto>{
	...
	private static class CharDto extends BinaryDto<CharDto>{
	...
	private static class IntDto extends BinaryDto<IntDto>{
		public final int f1;
	...
	private static class FloatDto extends BinaryDto<FloatDto>{
	...
	private static class DoubleDto extends BinaryDto<DoubleDto>{
	...
	private static class StringDto extends BinaryDto<StringDto>{
	...
	private static class RootDto extends BinaryDto<RootDto>{
	...
	private static final RootDto DTO = new RootDto(
...
//	}
	private static final String DTO_HEX = """
			
			00010164
			""";
	...
	@Test
	public void testAgainstStoredValue(){
		byte[] actualBytes = DTO.encodeIndexed();
		byte[] expectedBytes = HexBlockTool.fromHexBlock(DTO_HEX);
		Assert.assertEquals(actualBytes, expectedBytes);
		RootDto actualDto = BinaryDtoIndexedCodec.of(RootDto.class).decode(expectedBytes);
