...
public class MilliTimeToLongBinaryDtoFieldConverter
extends BinaryDtoConvertingFieldCodec<MilliTime,Long>{

	public MilliTimeToLongBinaryDtoFieldConverter(){
		super(MilliTime::toEpochMilli, MilliTime::ofEpochMilli, new LongBinaryDtoFieldCodec(), true);
	}
