...
public class ByteLengthToLongBinaryDtoFieldConverter
extends BinaryDtoConvertingFieldCodec<ByteLength,Long>{

	public ByteLengthToLongBinaryDtoFieldConverter(){
		super(ByteLength::toBytes, ByteLength::ofBytes, new LongBinaryDtoFieldCodec(), true);
	}
