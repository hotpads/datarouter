...
public class RateLimiterConfig{
	...
	public void initNameRateLimiter(NamedMemcachedRateLimiterFactory namedMemcachedRateLimiterFactory){
		this.nameRateLimiter = Lazy.of(() -> namedMemcachedRateLimiterFactory.new NamedMemcachedRateLimiter(name, avg,
				spike, periods, bucketPeriod, unit));
	}
