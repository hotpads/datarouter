...
import io.datarouter.client.memcached.MemcachedReservedBlobPaths;
...
public class MemcachedDatabeanNodeTool{
	...
	public static Subpath makeSubpath(
		...
		Subpath subpath = MemcachedReservedBlobPaths.DATABEAN.append(new Subpath(shortenedString));
		logger.warn("shortening {} to {}",
				MemcachedReservedBlobPaths.DATABEAN.append(new Subpath(segments)),
				subpath);
		return subpath;
	}
