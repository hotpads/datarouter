...
public class HBaseNonEntityQueryBuilderTests{
	...
	public void testGetConcatenatedValueBytes(){
		...
		Bytes withoutTrailingByte = new Bytes(HBaseNonEntityQueryBuilder.getConcatenatedValueBytesUnterminated(fields));
