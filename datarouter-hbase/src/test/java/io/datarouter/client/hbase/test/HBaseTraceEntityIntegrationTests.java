...
public class HBaseTraceEntityIntegrationTests extends BaseTraceEntityIntegrationTests{

	@Inject
	public HBaseTraceEntityIntegrationTests(
			Datarouter datarouter,
			EntityNodeFactory entityNodeFactory,
			WideNodeFactory wideNodeFactory){
		super(datarouter, entityNodeFactory, wideNodeFactory, DatarouterHBaseTestClientIds.HBASE);
	}
