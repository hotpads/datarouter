...
public abstract class BaseHBaseEntityCellBatchLoader<
...
extends BaseBatchLoader<T>{
	...
	public BaseHBaseEntityCellBatchLoader(final HBaseSubEntityReaderNode<EK,E,PK,D,F> node, int partition,
	...
	abstract List<T> parseHBaseResult(List<KeyValue> cells);
	abstract PK getLastPrimaryKeyFromBatch();


	@Override
	public BaseHBaseEntityCellBatchLoader<EK,E,PK,D,F,T> call(){
		//do the RPC
