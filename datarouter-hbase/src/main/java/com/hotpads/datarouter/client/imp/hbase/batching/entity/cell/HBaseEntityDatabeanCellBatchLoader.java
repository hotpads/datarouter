package com.hotpads.datarouter.client.imp.hbase.batching.entity.cell;
...
public class HBaseEntityDatabeanCellBatchLoader<
		EK extends EntityKey<EK>,
		E extends Entity<EK>,
		PK extends EntityPrimaryKey<EK,PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>>
extends BaseHBaseEntityCellBatchLoader<EK,E,PK,D,F,D>{

	public HBaseEntityDatabeanCellBatchLoader(final HBaseSubEntityReaderNode<EK,E,PK,D,F> node, int partition,
	...
	@Override
	protected List<D> parseHBaseResult(List<KeyValue> kvs){
	...
	public BatchLoader<D> getNextLoader(){
		...
		return new HBaseEntityDatabeanCellBatchLoader<>(node, partition, partitionBytes, nextRange, config,
				batchChainCounter + 1);
	}
}