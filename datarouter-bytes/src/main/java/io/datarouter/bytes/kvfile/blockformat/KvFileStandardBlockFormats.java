...
public class KvFileStandardBlockFormats{
	...
	@SuppressWarnings("unchecked")// because of the generic type on KvFileBlockCodec
	public static final KvFileBlockFormat
			SEQUENTIAL = new KvFileBlockFormat("SEQUENTIAL", KvFileSequentialBlockCodec::new);
