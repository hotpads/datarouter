...
public enum UrlScheme {
	...
	public static final String LOCAL_DEV_SERVER_URL = HTTP.stringRepresentation +"://" + LOCAL_HOST + ":" + PORT_HTTP_DEV;
	public static final String LOCAL_DEV_SERVER_HTTPS_URL = HTTPS.stringRepresentation + "://" + LOCAL_HOST + ":" + PORT_HTTPS_DEV;
