...
public class BackupRecordKey extends BasePrimaryKey<BackupRecordKey>{
	...
	private byte[] endKey;
	private List<Field<?>> startKeyFields;
	private List<Field<?>> endKeyFields;
	...
	public static final String
		...
		COL_endKey = "endKey",
		COL_startKeyFields = "startKeyFields",
		COL_endKeyFields = "endKeyFields",
		COL_created = "created";
	...
	public BackupRecordKey(String clientName, String tableName, String subEntityPrefix){
		this(clientName, tableName, subEntityPrefix, null, null);
	}

	public static BackupRecordKey createPrefix(String clientName, String tableName, String subEntityPrefix){
		return new BackupRecordKey(clientName, tableName, subEntityPrefix);
	}
