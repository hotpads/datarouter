...
public class ServerClusterDomains implements Supplier<Collection<String>>{
	...
	@Inject
	public ServerClusterDomains(ComputedPropertiesFinder finder){
		this.clusterDomains = finder.findPropertyStringsSplitWithComma(SERVER_CLUSTER_DOMAINS);
	}
