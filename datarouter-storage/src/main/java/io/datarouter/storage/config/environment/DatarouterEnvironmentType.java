...
public class DatarouterEnvironmentType{
	...
	public DatarouterEnvironmentType(String persistentString){
	...
	public boolean equals(Object obj){
		...
		DatarouterEnvironmentType other = (DatarouterEnvironmentType)obj;
	...
	public String toString(){
		return "DatarouterEnvironmentType [persistentString=" + persistentString + "]";
	}
