...
public class DatarouterConfigProfile{
	...
	public DatarouterConfigProfile(String persistentString){
	...
	public boolean equals(Object obj){
		...
		DatarouterConfigProfile other = (DatarouterConfigProfile)obj;
	...
	public String toString(){
		return "DatarouterConfigProfile [persistentString=" + persistentString + "]";
	}
