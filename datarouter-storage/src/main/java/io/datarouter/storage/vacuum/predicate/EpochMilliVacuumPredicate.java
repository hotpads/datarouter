 ...
 */
public class EpochMilliVacuumPredicate<T> implements Predicate<T>{

	private final long cutoff;
	private final Function<T,Long> timeExtractor;

	public EpochMilliVacuumPredicate(long cutoff, Function<T,Long> timeExtractor){
		this.cutoff = cutoff;
	...
	public boolean test(T item){
		return timeExtractor.apply(item) < cutoff;
	}
