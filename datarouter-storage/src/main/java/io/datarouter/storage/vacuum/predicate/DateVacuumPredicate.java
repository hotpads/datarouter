...
public class DateVacuumPredicate<T> implements Predicate<T>{
	...
	public DateVacuumPredicate(long epochMilliCutoff, Function<T,Date> timeExtractor){
		this.epochMilliCutoff = epochMilliCutoff;
		this.timeExtractor = timeExtractor;
	}

	public DateVacuumPredicate(Date cutoff, Function<T,Date> dateExtractor){
		this(cutoff.getTime(), dateExtractor);
	}

	@Override
	public boolean test(T item){
		return timeExtractor.apply(item).getTime() < epochMilliCutoff;
	}
