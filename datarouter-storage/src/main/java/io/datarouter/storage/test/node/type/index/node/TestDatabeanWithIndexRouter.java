...
public abstract class TestDatabeanWithIndexRouter extends BaseRouter implements TestRouter{
	...
	public TestDatabeanWithIndexRouter(Datarouter datarouter, TestDatarouterProperties datarouterProperties,
			String routerName, NodeFactory nodeFactory, DatarouterSettings datarouterSettings, ClientId clientId,
			String tableName){
		super(datarouter, datarouterProperties.getDatarouterTestFileLocation(), routerName, nodeFactory,
				datarouterSettings);
