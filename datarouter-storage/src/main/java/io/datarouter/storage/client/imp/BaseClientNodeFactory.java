...
public abstract class BaseClientNodeFactory implements ClientNodeFactory{
	...
	@Override
	public final <PK extends PrimaryKey<PK>,
			D extends Databean<PK,D>,
			F extends DatabeanFielder<PK,D>>
	PhysicalNode<PK,D,F> createWrappedNode(NodeParams<PK,D,F> nodeParams){
		WrappedNodeFactory<PK,D,F,?> factory = makeWrappedNodeFactory();
		return factory.createWrappedNode(nodeParams);
	}

	protected abstract <PK extends PrimaryKey<PK>,
			D extends Databean<PK,D>,
			F extends DatabeanFielder<PK,D>>
	...
	@Override
	public final <EK extends EntityKey<EK>,
			E extends Entity<EK>,
