...
import io.datarouter.storage.node.adapter.trace.mixin.IndexedStorageTraceAdapterMixin;
...
public class PhysicalIndexedSortedMapStorageTraceAdapter<
...
implements PhysicalIndexedSortedMapStorageNode<PK,D,F>,
		IndexedStorageTraceAdapterMixin<PK,D,F,N>,
		SortedStorageTraceAdapterMixin<PK,D,F,N>,
		MapStorageTraceAdapterMixin<PK,D,F,N>,
		PhysicalAdapterMixin<PK,D,F,N>{

	public PhysicalIndexedSortedMapStorageTraceAdapter(N backingNode){
		super(backingNode);
	}
