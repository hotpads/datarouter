...
public class PhysicalSubEntitySortedMapStorageTraceAdapter<
		EK extends EntityKey<EK>,
		PK extends EntityPrimaryKey<EK,PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>,
		N extends PhysicalSubEntitySortedMapStorageNode<EK,PK,D,F>>
extends PhysicalSortedMapStorageTraceAdapter<PK,D,F,N>
implements PhysicalSubEntitySortedMapStorageNode<EK,PK,D,F>{

	public PhysicalSubEntitySortedMapStorageTraceAdapter(N backingNode){
		super(backingNode);
	}
