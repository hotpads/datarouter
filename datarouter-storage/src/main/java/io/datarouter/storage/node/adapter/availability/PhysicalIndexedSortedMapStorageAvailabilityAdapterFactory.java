...
public class PhysicalIndexedSortedMapStorageAvailabilityAdapterFactory{
	...
	PhysicalIndexedSortedMapStorageAvailabilityAdapter<PK,D,F,N> create(N backingNode){
		return new PhysicalIndexedSortedMapStorageAvailabilityAdapter<>(backingNode);
	}
