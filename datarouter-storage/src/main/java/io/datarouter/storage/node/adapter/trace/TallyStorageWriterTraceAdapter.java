...
public class TallyStorageWriterTraceAdapter<
		PK extends PrimaryKey<PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>,
		N extends PhysicalTallyStorageWriterNode<PK,D,F>>
extends BaseTraceAdapter<PK,D,F,N>
implements TallyStorageWriter<PK,D>, MapStorageTraceAdapterMixin<PK,D,F,N>{

	public TallyStorageWriterTraceAdapter(N backingNode){
		super(backingNode);
	}
