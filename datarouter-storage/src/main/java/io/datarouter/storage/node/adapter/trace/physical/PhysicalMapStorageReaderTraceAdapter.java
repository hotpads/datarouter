...
import io.datarouter.storage.node.adapter.trace.mixin.MapStorageReaderTraceAdapterMixin;
import io.datarouter.storage.node.op.raw.read.MapStorageReader.PhysicalMapStorageReaderNode;
import io.datarouter.storage.serialize.fieldcache.PhysicalDatabeanFieldInfo;

public class PhysicalMapStorageReaderTraceAdapter<
		PK extends PrimaryKey<PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>,
		N extends PhysicalMapStorageReaderNode<PK,D,F>>
extends BaseTraceAdapter<PK,D,F,N>
implements PhysicalMapStorageReaderNode<PK,D,F>,
		MapStorageReaderTraceAdapterMixin<PK,D,F,N>,
		PhysicalAdapterMixin<PK,D,F,N>{

	public PhysicalMapStorageReaderTraceAdapter(N backingNode){
		super(backingNode);
	}
