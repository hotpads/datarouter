...
public class StringQueueMessageKey extends BaseRegularPrimaryKey<StringQueueMessageKey>{

	private String messageId;

	public StringQueueMessageKey(){
	}

	public StringQueueMessageKey(String messageId){
