...
public class JsonDatabeanToolTests{
	...
	private static ManyFieldBean makeTestBean(){
		var bean = new ManyFieldBean(33333L);
	...
	public void testRoundTrip(){
		...
		ManyFieldBeanKey keyOut = JsonDatabeanTool.primaryKeyFromJson(
				ManyFieldBeanKey.class,
				fielder.getKeyFielder(),
				keyJsonObject);
	...
	public void testMultiRoundTrip(){
		...
		List<SortedBeanKey> keysOut = JsonDatabeanTool.primaryKeysFromJson(
				SortedBeanKey.class,
				sortedBeanFielder.getKeyFielder(),
				jsonKeys);
		...
		List<SortedBean> databeansOut = JsonDatabeanTool.databeansFromJson(
				ReflectionTool.supplier(SortedBean.class),
				sortedBeanFielder,
				jsonDatabeans);
