...
import io.datarouter.storage.file.queue.DirectoryQueue;

@Guice
public class DirectoryQueueIntegrationTests{

	private static final String
			DIR = "/var/local/datarouter/test/storage/directoryQueue/";
	...
	public void beforeClass(){
		testDirectory = directoryManagerFactory.create(DIR).deleteDescendants();
	}
	...
	public void testSingleFile(){
		var singleFileQueue = new DirectoryQueue(testDirectory.createSubdirectory("singleFile/"));
	...
	public void testMultiFile(){
		var multiFileQueue = new DirectoryQueue(testDirectory.createSubdirectory("multiFile/"));
