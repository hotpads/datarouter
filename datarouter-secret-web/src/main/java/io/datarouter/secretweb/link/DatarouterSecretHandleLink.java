...
public class DatarouterSecretHandleLink extends DatarouterLink{

	public DatarouterSecretHandleLink(){
		super(new DatarouterSecretPaths().datarouter.secrets.handle);
	}
