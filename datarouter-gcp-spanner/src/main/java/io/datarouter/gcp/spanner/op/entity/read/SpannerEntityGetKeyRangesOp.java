...
public class SpannerEntityGetKeyRangesOp<
		EK extends EntityKey<EK>,
		PK extends EntityPrimaryKey<EK,PK>,
		D extends Databean<PK,D>,
		F extends DatabeanFielder<PK,D>>
extends SpannerGetKeyRangesOp<PK,D,F>
implements SpannerEntityOp{

	private final Integer partition;

	public SpannerEntityGetKeyRangesOp(
		...
		super(client,
				...
				config.setOffset(0),
				codecRegistry,
				SpannerEntityKeyTool.getEntityTableName(fieldInfo));
