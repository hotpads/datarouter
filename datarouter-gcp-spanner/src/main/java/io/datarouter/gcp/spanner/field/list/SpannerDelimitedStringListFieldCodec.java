...
public class SpannerDelimitedStringListFieldCodec
extends SpannerBaseFieldCodec<List<String>,DelimitedStringListField>{

	public SpannerDelimitedStringListFieldCodec(DelimitedStringListField field){
		super(field);
	}
