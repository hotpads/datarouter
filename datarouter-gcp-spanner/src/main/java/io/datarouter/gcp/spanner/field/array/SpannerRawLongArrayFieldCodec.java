...
public class SpannerRawLongArrayFieldCodec extends SpannerBaseFieldCodec<List<Long>,RawLongArrayField>{

	public SpannerRawLongArrayFieldCodec(RawLongArrayField field){
		super(field);
	}
