...
public class SpannerUInt63FieldCodec extends SpannerBaseFieldCodec<Long,UInt63Field>{

	public SpannerUInt63FieldCodec(UInt63Field field){
		super(field);
	}
	...
	public Long getValueFromResultSet(ResultSet rs){
		return rs.getLong(field.getKey().getColumnName());
	}
