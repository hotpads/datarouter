...
public class SpannerDoubleFieldCodec extends SpannerBaseFieldCodec<Double,DoubleField>{

	public SpannerDoubleFieldCodec(DoubleField field){
		super(field);
	}

	@Override
	public SpannerColumnType getSpannerColumnType(){
		return SpannerColumnType.FLOAT64;
	}

	@Override
	public Value getSpannerValue(){
		return SpannerValueTool.ofDouble(field.getValue());
	}
	...
	public Double getValueFromResultSet(ResultSet rs){
		return rs.getDouble(field.getKey().getColumnName());
	}
