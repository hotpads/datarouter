...
import io.datarouter.gcp.spanner.op.entity.read.SpannerEntityGetRangesOp;
...
public class SpannerEntityDatabeanScanner<
...
extends BaseNodeScanner<PK,D>{
	...
	public SpannerEntityDatabeanScanner(
	...
	protected List<D> loadRanges(Collection<Range<PK>> ranges, Config config){
		return new SpannerEntityGetRangesOp<>(client, fieldInfo, ranges, config, codecRegistry, parition).wrappedCall();
	}
