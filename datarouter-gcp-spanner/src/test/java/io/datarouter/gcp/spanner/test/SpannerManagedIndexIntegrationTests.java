...
public class SpannerManagedIndexIntegrationTests extends BaseManagedIndexIntegrationTests{

	public SpannerManagedIndexIntegrationTests(){
		super(SpannerTestCliendIds.SPANNER);
	}
