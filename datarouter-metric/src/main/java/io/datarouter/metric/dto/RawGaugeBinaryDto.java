...
public class RawGaugeBinaryDto extends BinaryDto<RawGaugeBinaryDto>{
	...
	public RawGaugeBinaryDto(String serviceName, String serverName, List<GaugeItemBinaryDto> items){
	...
	public static List<RawGaugeBinaryDto> createSizedDtos(GaugeBatchDto gaugeBatchDto, int itemsPerDto){
		...
		return Scanner.of(gaugeBatchDto.batch())
				...
				.batch(itemsPerDto)
				.map(items -> new RawGaugeBinaryDto(
	...
	public static RawGaugeBinaryDto decode(byte[] bytes){
		return BinaryDtoIndexedCodec.of(RawGaugeBinaryDto.class).decode(bytes);
	}
