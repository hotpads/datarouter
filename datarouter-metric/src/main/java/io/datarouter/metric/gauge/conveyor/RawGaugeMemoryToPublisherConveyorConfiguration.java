...
@Singleton
public class RawGaugeMemoryToPublisherConveyorConfiguration implements ConveyorConfiguration{
	private static final Logger logger = LoggerFactory.getLogger(RawGaugeMemoryToPublisherConveyorConfiguration.class);
